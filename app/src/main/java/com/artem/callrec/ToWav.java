...
public class ToWav {
    ...
    private static final String TAG = "ToWav";
    ...
    /**
     * Construct a ToWav, with all fields defaulting to zero.
     */
    public ToWav() {
    }

    /**
     * Construct a ToWav, with fields initialized.
     ...
     */
    public ToWav(short format, short numChannels, int sampleRate, short bitsPerSample, int numBytes) {
        mFormat = format;
     ...
     * @param format
     * one of {@link #FORMAT_PCM}, {@link #FORMAT_ULAW}, or {@link #FORMAT_ALAW}.
     * @return reference to this ToWav instance.
     */
    public ToWav setFormat(short format) {
        mFormat = format;
        return this;
    }
     ...
     * @return reference to this ToWav instance.
     */
    public ToWav setNumChannels(short numChannels) {
        mNumChannels = numChannels;
        return this;
    }
     ...
     * @return reference to this ToWav instance.
     */
    public ToWav setSampleRate(int sampleRate) {
        mSampleRate = sampleRate;
        return this;
    }
     ...
     * @return reference to this ToWav instance.
     */
    public ToWav setBitsPerSample(short bitsPerSample) {
        mBitsPerSample = bitsPerSample;
        return this;
    }
     ...
     * @return reference to this ToWav instance.
     */
    public ToWav setNumBytes(int numBytes) {
        mNumBytes = numBytes;
        return this;
    }

    /**
     * Read and initialize a ToWav.
    ...
    public String toString() {
        return String.format(
                "ToWav format=%d numChannels=%d sampleRate=%d bitsPerSample=%d numBytes=%d",
